...
function Profile() {
  ...
  const [userData, setUserData] = useState({ fullName: '', email: '', phoneNumber: '', address: '', username: '', photoURL: '' });
    ...
    <div className="flex h-screen">
      ...
      <MainContent>
        <div className="group relative w-full max-w-4xl mx-auto bg-white p-6 rounded-2xl shadow-2xl ">
          ...
          {activeTab === 'Personal Info' && (
            <div className="bg p-4 rounded-lg shadow-inner">
              ...
              {editing ? (
                ...
                <div>
                  <p className="text-gray-500"><strong>Phone Number:</strong> <span className="text-blue-500 text-sm"> {userData.phoneNumber}</span></p>
                  <p className="text-gray-500"><strong>Address:</strong> <span className="text-blue-500 text-sm">{userData.address}</span></p>
                  <p className="text-gray-500"><strong>Username:</strong> <span className="text-blue-500 text-sm">{userData.username}</span></p>
                  <button
          ...
          {alert.show && (
            <div className={`fixed bottom-4 right-4 p-4 rounded-lg shadow-lg bg-white border-l-4 ${alert.type === 'success' ? 'border-green-500' : 'border-red-500'}`}>
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" strokeWidth={0} fill="currentColor" stroke="currentColor" className={`w-6 h-6 ${alert.type === 'success' ? 'text-green-500' : 'text-red-500'}`}>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 15" strokeWidth={0} fill="none" stroke="currentColor" className="w-4 h-4">
