    ...
    <div className="flex flex-col h-screen w-64 bg-white shadow-lg">
      ...
      <div className="flex-grow overflow-y-auto p-4">
        <ul className="space-y-2">
          ...
          <li className="p-2 rounded-md cursor-pointer" onClick={() => setIsCoursesOpen(!isCoursesOpen)}>
            ...
            {isCoursesOpen && (
              <ul className="ml-6 mt-2 space-y-1 text-gray-700">
                ...
                <li className="hover:text-blue-500"><Link to="/addcourse">Add Course</Link></li>
          ...
          {/* Logout Button */}
          <li className="p-2 rounded-md hover:bg-red-100 text-red-600 cursor-pointer" onClick={handleLogout}>
            <div className="flex items-center space-x-2">
