  ...
  return (
    <div className="relative mt-20 border-b border-neutral-800 min-h-[800px]">
      <div className="text-center">
        <span className="backdrop-blur-sm bg-white/30 text-yellow-600 rounded-full h-6 text-sm font-bold font-poppins px-2 py-1 uppercase">
          Features
        </span>
            ...
            <div className="bg-white border border-neutral-300 rounded-xl shadow-md overflow-hidden transition-transform duration-300 ease-in-out hover:transform hover:-translate-y-2 hover:shadow-lg backdrop-blur-sm bg-white/30">
              <div className="flex items-start p-6">
                ...
                <div className="ml-4 font-poppins">
                  <h5 className="mt-1 mb-2 text-xl text-neutral-500 font-bold">
                    {feature.text}
                  </h5>
                  <hr className="my-2 border-t border-neutral-300" />
                  <p className="text-md text-neutral-500 font-bold">
                    {feature.description}
                  </p>
                </div>
              </div>s
