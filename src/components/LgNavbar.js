...
import { Menu, X, Bell, MessageSquare, ChevronDown, Settings, LifeBuoy, LogOut } from "lucide-react"
...
const LNavbar = () => {
  ...
  const [userCollection, setUserCollection] = useState(null) // Track user's collection
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      if (userDocSnap.exists()) {
        ...
        setUserCollection("users") // Set user collection
      } else {
        ...
        if (learnerSnap.exists()) {
          ...
          setUserCollection("learner") // Set user collection
        } else {
          ...
          if (internSnap.exists()) {
            ...
            setUserCollection("intern") // Set user collection
          } else {
            setUserData({
